...
public class GSGameOver : IGameState
{
    ...
    {
        if (LevelManager.instance.currLevel.getScore() > LevelManager.instance.highestScore) 
        {
            LevelManager.instance.highestScore = LevelManager.instance.currLevel.getScore();
        }
